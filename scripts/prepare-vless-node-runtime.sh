...
Optional env:
  ...
  PROVISIONER_BIND_HOST default 127.0.0.1
  PROVISIONER_PORT     provisioner HTTP port, default 3021
  ADMIN_USERNAME       admin UI username, default admin
  ADMIN_PASSWORD       admin UI password, default random value
...
PROVISIONER_BIND_HOST="${PROVISIONER_BIND_HOST:-127.0.0.1}"
...
PROVISIONER_BIND_HOST=$PROVISIONER_BIND_HOST
